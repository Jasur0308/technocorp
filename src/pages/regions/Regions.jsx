...
const Regions = () => {
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            <Breadcrumbs />
            <div className="p-6">
                <h1 className="text-3xl text-gray-500">Hududlar</h1>
                <Divider />
                ...
                <Table
                    ...
                    pagination={false}
                    title={() => <h2 className="text-lg font-semibold text-gray-500">Hududlar jadvali</h2>}
                />

                <Modal
                    open={isModalVisible}
                    title={editingRegion ? "Tahrirlash" : "Yangi hudud qo‘shish"}
                    onCancel={() => {
                        setIsModalVisible(false);
                        form.resetFields();
                        setEditingRegion(null);
                    ...
                    onOk={() => form.submit()}
                    okText={editingRegion ? "Saqlash" : "Qo‘shish"}
                >
