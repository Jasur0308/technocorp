...
const initialData = [
    { key: "1", firstName: "Javohir", lastName: "Juraev", email: "javohirjuraev1992@gmail.com", phone: "998 97 400-94-43", visible: true },
    { key: "2", firstName: "Alijon", lastName: "Nazarov", email: "a.nazarov@technocorp.uz", phone: "+9989700000", visible: true },
    { key: "3", firstName: "Arslan", lastName: "Muazikov", email: "arslan@arslan.uz", phone: "+9988974564564", visible: true },
    { key: "4", firstName: "Zukhriddin", lastName: "Khayrulloev", email: "zukhriddinkhayrulloev19930810@gmail.com", phone: "+998 90 993 62 83", visible: true },
    { key: "5", firstName: "Ahmad", lastName: "Xushvaqtov", email: "a.xushvaqtov@technocorp.uz", phone: "91 000-00-00", visible: true },
];
...
const Admins = () => {
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            <Breadcrumbs />
            <div className="p-6">
                <h1 className="text-3xl text-gray-500">Administratorlar</h1>
                <Divider />
            </div>
            ...
            <Table
                ...
                pagination={false}
                bordered
                title={() => <h2 className="text-lg font-semibold text-gray-500">Administratorlar jadvali</h2>}
            />

            <Modal
                open={open}
                title={editing ? "Tahrirlash" : "Yangi admin qo‘shish"}
                onCancel={() => {
                    setOpen(false);
                    setEditing(null);
                    form.resetFields();
