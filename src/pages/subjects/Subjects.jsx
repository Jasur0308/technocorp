...
const initialData = [
    {
        key: "1",
        name: "Telekommunikatsiya xizmatlari yo'nalishida",
        visible: true,
    },
    {
        key: "2",
...
const Subjects = () => {
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            <Breadcrumbs />
            <div className="p-6">
                <h1 className="text-3xl text-gray-500">Sub'ektlar</h1>
                <Divider />
                ...
                <Table
                    ...
                    pagination={false}
                    title={() => <h2 className="text-lg font-semibold text-gray-500">Sub'ektlar jadvali</h2>}
                />

                <Modal
                    open={isModalVisible}
                    title={editingSubject ? "Tahrirlash" : "Yangi sub'ekt qo‘shish"}
                    onCancel={() => {
                        setIsModalVisible(false);
                        form.resetFields();
                        setEditingSubject(null);
                ...
                >
                    <Form form={form} layout="vertical" onFinish={onFinish}>
                        <Form.Item
                            name="name"
                            label="Nomi"
                            rules={[{ required: true, message: "Sub'ektni kiriting" }]}
                        >
                            <Input />
                        </Form.Item>
                        <Form.Item
